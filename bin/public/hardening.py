...
from hardening.antivirus import install_antivirus
...
from hardening.general import setup_general
...
def build_commands(commands):
  commands.add("harden",   harden,  help="Hardening server")
  commands.add("harden_ssh",   harden,  help="Hardening SSH server and client")
