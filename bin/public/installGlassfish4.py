...
# NOTE: Remember to change path in "var/glassfish/glassfish-4.1"
...
def _install_glassfish():
    ...
    if not os.access("/usr/local/glassfish4/glassfish", os.F_OK):
        ...
        x("/usr/local/glassfish4/bin/asadmin create-service")
        x("su glassfish /usr/local/glassfish4/bin/asadmin start-domain")
